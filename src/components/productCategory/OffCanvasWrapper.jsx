...
const OffCanvasWrapper = (props) => {
  ...
  return (
    <OffCanvas alignItems="center" justifyContent="center"
        ...
        <Carousel propsObject={{images,imageStyles:{maxHeight:"100%",maxWidth:"60%"},displayImageIndex,setDisplayImageIndex,carouselStyles:{display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer"},handleClick}}>
            ...
            <div style={{position:"absolute",width:"fit-content",top:"0",right:"0",height:"100%"}}>
                <CarouselNextControl propsObject={{styleObject:{display:"flex",alignItems:"center",paddingRight:"1.5rem",position:"relative"},setDisplayImageIndex,imageCount,float:"right"}}>
